...
public sealed class MindShieldSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<MemoryShieldImplantComponent, ImplantImplantedEvent>(OnMEMSHIELDImplantImplanted);//Rayten
        SubscribeLocalEvent<MemoryShieldImplantComponent, EntGotRemovedFromContainerMessage>(OnMEMSHIELDImplantDraw);//Rayten
    }
    //RAYTEN-START
    private void OnMEMSHIELDImplantImplanted(Entity<MemoryShieldImplantComponent> ent, ref ImplantImplantedEvent ev)
    {
    ...
    private void OnMEMSHIELDImplantDraw(Entity<MemoryShieldImplantComponent> ent, ref EntGotRemovedFromContainerMessage args)
    {
