...
skill-system-UI-Tooltip-Medicine =
    0 ур:
    - 0.5 скорости дефибрилляции, лечения при помощи наборов от ушибов, бинтов, мази, регенеративной сети и медицинской нити.
    1 ур:
    - Обычная длительность дефибрилляции, лечения при помощи наборов от ушибов, бинтов, мази, регенеративной сети и медицинской нити.
    2 ур:
    - Использование шприцов.
    - Использование ХимкоМата, ХимМастера, раздатчика химикатов.
