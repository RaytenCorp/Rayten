...
ent-WeaponShotgunHushpup = Hushpup
    .desc = Малоизвестная модификация силовика, оснащённая экспериментальным глушителем. Отличный выбор для тех, у кого строгий моральный кодекс. Использует патроны калибра .50 ружейный.
