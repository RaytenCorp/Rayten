...
lobby-state-background-text = Лобби арт: [color=white]{ $backgroundTitle }[/color], автор — [color=white]{ $backgroundArtist }[/color]
...
lobby-state-background-unknown-artist = [color=dimgray]Неизвестный исполнитель[/color]
